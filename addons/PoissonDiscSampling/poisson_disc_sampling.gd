...
static func generate_points_for_circle(circle_position: Vector2, circle_radius: float, poisson_radius: float, retries: int, start_point := Vector2.INF, max_points := -1) -> PackedVector2Array:
...
static func generate_points_for_polygon(polygon: PackedVector2Array, poisson_radius: float, retries: int, start_point := Vector2.INF, max_points := -1) -> PackedVector2Array:
	...
	return _generate_points(ShapeType.POLYGON, sample_region_rect, poisson_radius, retries, start_point, max_points)


static func _generate_points(shape: int, sample_region_rect: Rect2, poisson_radius: float, retries: int, start_pos: Vector2, max_points: int) -> PackedVector2Array:
